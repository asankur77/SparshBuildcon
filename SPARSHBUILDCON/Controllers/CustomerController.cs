    ...
    public class CustomerController : Controller
    {
        ...
        public ActionResult SLPReturn()
        {
            ...
            else
            {
                ...
                var rclist = db.MISInstallmenttabs.Where(c => c.newbondid == User.Identity.Name).ToList();
                var br = db.appltabs.Single(b => b.newbondid == User.Identity.Name);
