...
namespace SPARSHBUILDCON.Models
{
    ...
    public class MyClass
    {
        public static void Sendmsg(string receiver, string msg)
        {
            ...
            //string url = @"http://sms.xpertgroup.in/api/pushsms.php?username=XPRTGPRS&password=XPRTGPRS&sender=SPARSH&message=" + msg + "&numbers=" + receiver + "&unicode=false";
            //string url = @"http://alotsolutions.in/API/WebSMS/Http/v1.0a/index.php?unique=1&username=XPRTGPRS&password=XPRTGP&sender=SPARSH&to=" + receiver + "&message=" + msg + "";
            try
            {
        ...
        {
            string url = @"http://sms.technomate.mobi/api/swsendUni2.asp?username=t1welltoss&password=carewe078066&sender=XPRTGP&sendto=" + receiver + "&message=" + msg + "";
            //string url = @"http://sms.xpertgroup.in/api/pushsms.php?username=XPRTGPRS&password=SPARSH&sender=SPARSH&message=" + msg + "&numbers=" + receiver + "&unicode=true";
            //string url = @"http://alotsolutions.in/API/WebSMS/Http/v1.0a/index.php?msgtype=unicode&username=XPRTGPRS&password=XPRTGP&sender=SPARSH&to=" + receiver + "&message=" + msg + "";
            try
            {
                HttpWebRequest req = (HttpWebRequest)WebRequest.Create(url);
                HttpWebResponse resp = (HttpWebResponse)req.GetResponse();
